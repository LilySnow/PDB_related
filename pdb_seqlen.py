...
"""
Calculates the length of sequence from a PDB file.

usage: python pdb_seqlen.py <pdb file>
example: python pdb_seqlen.py 3CRO.pdb
...
if __name__ == '__main__':
    ...
    try:
        ...
        for chain in pdb_seq:
            ...
            # msg = "{0} {1}".format(chain, len(seq))
            msg = tmp + "{0}\t{1}\t".format(chain, len(seq))
            tmp = msg
        msg = pdbfn + "\t" + msg.rstrip("\t") + "\n"
